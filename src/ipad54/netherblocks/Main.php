...
class Main extends PluginBase
{
    ...
    public function initBlocks(): void
    {
        ...
        if ($cfg->isEnableWood()) {
            $this->registerBlock(new Planks(new BID(CustomIds::CRIMSON_PLANKS_BLOCK, 0, CustomIds::CRIMSON_PLANKS_ITEM), "Crimson Planks", new BlockBreakInfo(2, BlockToolType::AXE, 0, 3)));
            $this->registerBlock(new Planks(new BID(CustomIds::WARPED_PLANKS_BLOCK, 0, CustomIds::WARPED_PLANKS_ITEM), "Warped Planks", new BlockBreakInfo(2, BlockToolType::AXE, 0, 3)));
    ...
    public function initItems(): void
    {
        ...
        if ($cfg->isEnablePigstep()) {
            $this->registerItem(new Record(new ItemIdentifier(CustomIds::RECORD_PIGSTEP, 0), RecordType::DISK_PIGSTEP(), "Pigstep"));
        }
        if($cfg->isEnableWood()){
