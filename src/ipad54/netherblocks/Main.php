...
class Main extends PluginBase
{
	...
	public function initBlocks(): void
	{
		...
		if($cfg->isEnableLodestone()) {
			$this->registerBlock(new Lodestone(new BID(CustomIds::LODESTONE_BLOCK, 0, CustomIds::LODESTONE_ITEM, TileLodestone::class), "Lodestone", new BlockBreakInfo(3.5, BlockToolType::PICKAXE, ToolTier::WOOD()->getHarvestLevel(), 3.5)));
		}
